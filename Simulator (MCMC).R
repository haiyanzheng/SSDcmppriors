...
## Throughout, N = c(n_A, n_B)                                               ##
#----- to evaluate the average coverage probability of the posterior HPD -----#
tmixpstCP2 = function(Sc, N = c(10, 10), true.mu, sig02, 
  ...
  tMixFit <- bugs(data = cmsdata, inits = cmsinits, model.file = "MyMod2.txt", 
                  parameters = c("mu"), 
                  n.chains = 1, n.iter = 13000, n.burnin = 3000, bugs.seed = 1)
...
#------- to evaluate the average interval length of the posterior HPD -------#
tmixpstEV2 = function(Sc, N = c(10, 10), true.mu, sig02, df, epsil0, wk, dw, br, s0 = 0.05){
...
MySSI =  ACCunknvar(R = 0.5, sk2 = MySc1[,2], wk = MyWgt1, 
                    df = 3, l0 = 0.65, alpha = 0.05, 
                    dw = c(2, 2), br = c(18, 3), s0 = 0.05) 
MySSII = ACCunknvar(R = 0.5, sk2 = MySc1[,2], wk = MyWgt2, 
                    df = 3, l0 = 0.65, alpha = 0.05, 
                    dw = c(2, 2), br = c(18, 3), s0 = 0.05) 
#----------------------------------------------------------------------------#
nsim = 100000
...
for(i in 1:nsim){
  ...
  tMixCvrProbI[i] = tmixpstCP2(Sc = MySc1, N = c(MySSI/2, MySSI/2), true.mu = SimMuI[i],
                              sig02 = 0.35, df = 3, l0 = 0.65, wk = MyWgt1,
                              dw = c(2, 2), br = c(18, 3), s0 = 0.05)
  
  tMixCvrProbII[i] = tmixpstCP2(Sc = MySc1, N = c(MySSII/2, MySSII/2), true.mu = SimMuII[i],
                               sig02 = 0.35, df = 3, l0 = 0.65, wk = MyWgt2,
                               dw = c(2, 2), br = c(18, 3), s0 = 0.05)
}
...
#----------------------------------------------------------------------------#
MySSIII = APVCunknvar(R = 0.5, sk2 = MySc1[,2], wk = MyWgt1, epsil0 = 0.03, 
                      df = 3, dw = c(2, 2), br = c(18, 3), s0 = 0.05)
MySSIV = APVCunknvar(R = 0.5, sk2 = MySc1[,2], wk = MyWgt2, epsil0 = 0.03, 
                     df = 3, dw = c(2, 2), br = c(18, 3), s0 = 0.05)
...
set.seed(123)
for(i in 1:nsim){
  tMixPredMuI[i] = tmixpstEV2(Sc = MySc1, N = c(MySSIII/2, MySSIII/2), true.mu = SimMuIII[i],
                             sig02 = 0.35, df = 3, epsil0 = 0.03, wk = MyWgt1,
                             dw = c(2, 2), br = c(18, 3), s0 = 0.05)
  
  tMixPredMuII[i] = tmixpstEV2(Sc = MySc1, N = c(MySSIV/2, MySSIV/2), true.mu = SimMuIV[i],
                              sig02 = 0.35, df = 3, epsil0 = 0.03, wk = MyWgt2,
                              dw = c(2, 2), br = c(18, 3), s0 = 0.05)
}
